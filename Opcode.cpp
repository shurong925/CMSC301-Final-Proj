...
// Initializes all the fields for every instruction in Opcode enum
{
  ...
  myArray[SUB].name = "sub"; myArray[SUB].numOps = 3; myArray[SUB].rdPos = 0; myArray[SUB].rsPos = 1; myArray[ADD].rtPos = 2; myArray[ADD].immPos = -1; myArray[SUB].instType = RTYPE; myArray[SUB].op_field = "000000"; myArray[SUB].funct_field = "100010";
  ...
  myArray[BEQ].name = "beq"; myArray[BEQ].numOps = 3;  myArray[BEQ].rdPos = -1;  myArray[BEQ].rsPos = 0;  myArray[BEQ].rtPos = 1;  myArray[BEQ].immPos = 2;  myArray[BEQ].instType = BTYPE;   myArray[BEQ].op_field = "000100"; myArray[BEQ].immLabel = true;
