...
// Initializes all the fields for every instruction in Opcode enum
{
  ...
  //Your code here
    myArray[ADDI].name = "addi"; myArray[ADDI].numOps = 3;  myArray[ADDI].rtPos = 0; myArray[ADDI].rsPos = 1; myArray[ADDI].immPos = 2; myArray[ADDI].instType = ITYPE; myArray[ADDI].op_field = "001000";

    myArray[SUB].name = "sub"; myArray[SUB].numOps = 3;  myArray[SUB].rsPos = 0; myArray[SUB].rdPos = 0;  myArray[SUB].rsPos = 1;  myArray[SUB].rtPos = 2; myArray[SUB].instType = RTYPE; myArray[SUB].op_field = "000000"; myArray[SUB].funct_field = "100010";

    myArray[J].name = "j";  myArray[J].numOps = 1;  myArray[J].immPos = 0;  myArray[J].instType = JTYPE; myArray[J].op_field = "000010"; myArray[J].immLabel = true;
    ...
    myArray[LW].name = "lw"; myArray[LW].numOps = 3;  myArray[LW].rtPos = 0; myArray[LW].rsPos = 1; myArray[LW].immPos = 2;  myArray[LW].instType = ITYPE; myArray[LW].op_field = "000000";

    myArray[SW].name = "sw"; myArray[SW].numOps = 3;  myArray[SW].rtPos = 0; myArray[SW].rsPos = 1; myArray[SW].immPos = 2;;  myArray[SW].instType = ITYPE; myArray[SW].op_field = "101011";
