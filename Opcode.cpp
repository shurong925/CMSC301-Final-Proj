...
// Initializes all the fields for every instruction in Opcode enum
{
  ...
  //Your code here
    ...
    myArray[LW].name = "lw"; myArray[LW].numOps = 3;  myArray[LW].rdPos = -1;  myArray[LW].rsPos = 2;  myArray[LW].rtPos = 0;  myArray[LW].instType = ITYPE; myArray[LW].op_field = "000000";

    myArray[SW].name = "sw"; myArray[SW].numOps = 3;  myArray[SW].rdPos = -1;  myArray[SW].rsPos = 2;  myArray[SW].rtPos = 0;  myArray[SW].instType = ITYPE; myArray[SW].op_field = "101011";
